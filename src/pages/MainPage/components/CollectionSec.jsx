    ...
    $direction === 'left'
      ? `
        ...
        background: linear-gradient(
          to right,
          ${theme.mode === 'dark' ? 'rgba(10, 5, 24, 0.92)' : 'rgba(236, 233, 255, 0.92)'} 0%,
          ${theme.mode === 'dark' ? 'rgba(10, 5, 24, 0.72)' : 'rgba(236, 233, 255, 0.72)'} 22%,
          ${theme.mode === 'dark' ? 'rgba(10, 5, 24, 0.36)' : 'rgba(236, 233, 255, 0.38)'} 52%,
          transparent 100%
        );
      `
      : `
